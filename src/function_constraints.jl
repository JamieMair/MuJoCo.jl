...
- **`geom2::Int32`**
- **`distmax::Float64`**
- **`fromto::Matrix{Float64}`** -> A matrix variable size. Check additional info for sizes.
...
- **`Da::Matrix{Float64}`** -> A matrix variable size. Check additional info for sizes.
- **`Db::Matrix{Float64}`** -> A matrix variable size. Check additional info for sizes.
