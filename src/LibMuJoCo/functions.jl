...
function Base.getproperty(x::Ptr{mjVisual_}, f::Symbol)
    f === :_global && return Ptr{var"##Ctag#459"}(x + 0)
    f === :quality && return Ptr{var"##Ctag#460"}(x + 40)
    f === :headlight && return Ptr{var"##Ctag#461"}(x + 60)
    f === :map && return Ptr{var"##Ctag#462"}(x + 100)
    f === :scale && return Ptr{var"##Ctag#463"}(x + 152)
    f === :rgba && return Ptr{var"##Ctag#464"}(x + 216)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{mjvSceneState_}, f::Symbol)
    ...
    f === :model && return Ptr{var"##Ctag#465"}(x + 8680)
    f === :data && return Ptr{var"##Ctag#466"}(x + 10560)
    return getfield(x, f)
end
