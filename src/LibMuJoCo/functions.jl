...
function Base.getproperty(x::Ptr{mjVisual_}, f::Symbol)
    f === :_global && return Ptr{var"##Ctag#304"}(x + 0)
    f === :quality && return Ptr{var"##Ctag#305"}(x + 40)
    f === :headlight && return Ptr{var"##Ctag#306"}(x + 60)
    f === :map && return Ptr{var"##Ctag#307"}(x + 100)
    f === :scale && return Ptr{var"##Ctag#308"}(x + 152)
    f === :rgba && return Ptr{var"##Ctag#309"}(x + 216)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{mjvSceneState_}, f::Symbol)
    ...
    f === :model && return Ptr{var"##Ctag#310"}(x + 8680)
    f === :data && return Ptr{var"##Ctag#311"}(x + 10560)
    return getfield(x, f)
end
