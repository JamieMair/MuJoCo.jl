...
function Base.getproperty(x::Data, f::Symbol)
    ...
    f === :warning && return unsafe_wrap(Array, Ptr{mjWarningStat_}(internal_pointer + 48), (8,))
    f === :timer && return unsafe_wrap(Array, Ptr{mjTimerStat_}(internal_pointer + 112), (13,))
    f === :solver && return unsafe_wrap(Array, Ptr{mjSolverStat_}(internal_pointer + 320), (1000,))
    ...
    f === :solver_fwdinv && return unsafe_wrap(Array, Ptr{Float64}(internal_pointer + 40328), (2,))
    ...
    f === :energy && return unsafe_wrap(Array, Ptr{Float64}(internal_pointer + 40388), (2,))
