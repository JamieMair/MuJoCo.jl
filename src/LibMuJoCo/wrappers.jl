...
function Base.getproperty(x::jlModel, f::Symbol)
...
function Base.propertynames(x::jlModel)
...
function Base.getproperty(x::jlData, f::Symbol)
    internal_pointer = getfield(x, :internal_pointer)
...
function Base.propertynames(x::jlData)
