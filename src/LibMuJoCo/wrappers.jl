...
function Base.getproperty(x::Data, f::Symbol)
    ...
    f === :qpos && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40432)), (Int(model.nq), Int(1)))
    f === :qvel && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40440)), (Int(model.nv), Int(1)))
    f === :act && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40448)), (Int(model.na), Int(1)))
    f === :qacc_warmstart && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40456)), (Int(model.nv), Int(1)))
    f === :plugin_state && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40464)), (Int(model.npluginstate), Int(1)))
    f === :ctrl && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40472)), (Int(model.nu), Int(1)))
    f === :qfrc_applied && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40480)), (Int(model.nv), Int(1)))
    f === :xfrc_applied && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40488)), (Int(model.nbody), Int(6)))
    f === :mocap_pos && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40496)), (Int(model.nmocap), Int(3)))
    f === :mocap_quat && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40504)), (Int(model.nmocap), Int(4)))
    f === :qacc && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40512)), (Int(model.nv), Int(1)))
    f === :act_dot && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40520)), (Int(model.na), Int(1)))
    f === :userdata && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40528)), (Int(model.nuserdata), Int(1)))
    f === :sensordata && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40536)), (Int(model.nsensordata), Int(1)))
    ...
    f === :xpos && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40560)), (Int(model.nbody), Int(3)))
    f === :xquat && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40568)), (Int(model.nbody), Int(4)))
    f === :xmat && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40576)), (Int(model.nbody), Int(9)))
    f === :xipos && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40584)), (Int(model.nbody), Int(3)))
    f === :ximat && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40592)), (Int(model.nbody), Int(9)))
    f === :xanchor && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40600)), (Int(model.njnt), Int(3)))
    f === :xaxis && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40608)), (Int(model.njnt), Int(3)))
    f === :geom_xpos && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40616)), (Int(model.ngeom), Int(3)))
    f === :geom_xmat && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40624)), (Int(model.ngeom), Int(9)))
    f === :site_xpos && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40632)), (Int(model.nsite), Int(3)))
    f === :site_xmat && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40640)), (Int(model.nsite), Int(9)))
    f === :cam_xpos && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40648)), (Int(model.ncam), Int(3)))
    f === :cam_xmat && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40656)), (Int(model.ncam), Int(9)))
    f === :light_xpos && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40664)), (Int(model.nlight), Int(3)))
    f === :light_xdir && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40672)), (Int(model.nlight), Int(3)))
    f === :subtree_com && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40680)), (Int(model.nbody), Int(3)))
    f === :cdof && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40688)), (Int(model.nv), Int(6)))
    f === :cinert && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40696)), (Int(model.nbody), Int(10)))
    f === :ten_wrapadr && return UnsafeArray(unsafe_load(Ptr{Ptr{Int32}}(internal_pointer + 40704)), (Int(model.ntendon), Int(1)))
    f === :ten_wrapnum && return UnsafeArray(unsafe_load(Ptr{Ptr{Int32}}(internal_pointer + 40712)), (Int(model.ntendon), Int(1)))
    f === :ten_J_rownnz && return UnsafeArray(unsafe_load(Ptr{Ptr{Int32}}(internal_pointer + 40720)), (Int(model.ntendon), Int(1)))
    f === :ten_J_rowadr && return UnsafeArray(unsafe_load(Ptr{Ptr{Int32}}(internal_pointer + 40728)), (Int(model.ntendon), Int(1)))
    f === :ten_J_colind && return UnsafeArray(unsafe_load(Ptr{Ptr{Int32}}(internal_pointer + 40736)), (Int(model.ntendon), Int(model.nv)))
    f === :ten_length && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40744)), (Int(model.ntendon), Int(1)))
    f === :ten_J && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40752)), (Int(model.ntendon), Int(model.nv)))
    f === :wrap_obj && return UnsafeArray(unsafe_load(Ptr{Ptr{Int32}}(internal_pointer + 40760)), (Int(model.nwrap), Int(2)))
    f === :wrap_xpos && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40768)), (Int(model.nwrap), Int(6)))
    f === :actuator_length && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40776)), (Int(model.nu), Int(1)))
    f === :actuator_moment && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40784)), (Int(model.nu), Int(model.nv)))
    f === :crb && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40792)), (Int(model.nbody), Int(10)))
    f === :qM && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40800)), (Int(model.nM), Int(1)))
    f === :qLD && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40808)), (Int(model.nM), Int(1)))
    f === :qLDiagInv && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40816)), (Int(model.nv), Int(1)))
    f === :qLDiagSqrtInv && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40824)), (Int(model.nv), Int(1)))
    f === :bvh_active && return UnsafeArray(unsafe_load(Ptr{Ptr{UInt8}}(internal_pointer + 40832)), (Int(model.nbvh), Int(1)))
    f === :ten_velocity && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40840)), (Int(model.ntendon), Int(1)))
    f === :actuator_velocity && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40848)), (Int(model.nu), Int(1)))
    f === :cvel && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40856)), (Int(model.nbody), Int(6)))
    f === :cdof_dot && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40864)), (Int(model.nv), Int(6)))
    f === :qfrc_bias && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40872)), (Int(model.nv), Int(1)))
    f === :qfrc_passive && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40880)), (Int(model.nv), Int(1)))
    f === :efc_vel && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40888)), (Int(data.nefc), Int(1)))
    f === :efc_aref && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40896)), (Int(data.nefc), Int(1)))
    f === :subtree_linvel && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40904)), (Int(model.nbody), Int(3)))
    f === :subtree_angmom && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40912)), (Int(model.nbody), Int(3)))
    f === :qH && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40920)), (Int(model.nM), Int(1)))
    f === :qHDiagInv && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40928)), (Int(model.nv), Int(1)))
    f === :D_rownnz && return UnsafeArray(unsafe_load(Ptr{Ptr{Int32}}(internal_pointer + 40936)), (Int(model.nv), Int(1)))
    f === :D_rowadr && return UnsafeArray(unsafe_load(Ptr{Ptr{Int32}}(internal_pointer + 40944)), (Int(model.nv), Int(1)))
    f === :D_colind && return UnsafeArray(unsafe_load(Ptr{Ptr{Int32}}(internal_pointer + 40952)), (Int(model.nD), Int(1)))
    f === :B_rownnz && return UnsafeArray(unsafe_load(Ptr{Ptr{Int32}}(internal_pointer + 40960)), (Int(model.nbody), Int(1)))
    f === :B_rowadr && return UnsafeArray(unsafe_load(Ptr{Ptr{Int32}}(internal_pointer + 40968)), (Int(model.nbody), Int(1)))
    f === :B_colind && return UnsafeArray(unsafe_load(Ptr{Ptr{Int32}}(internal_pointer + 40976)), (Int(model.nB), Int(1)))
    f === :qDeriv && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40984)), (Int(model.nD), Int(1)))
    f === :qLU && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 40992)), (Int(model.nD), Int(1)))
    f === :actuator_force && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 41000)), (Int(model.nu), Int(1)))
    f === :qfrc_actuator && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 41008)), (Int(model.nv), Int(1)))
    f === :qfrc_smooth && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 41016)), (Int(model.nv), Int(1)))
    f === :qacc_smooth && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 41024)), (Int(model.nv), Int(1)))
    f === :qfrc_constraint && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 41032)), (Int(model.nv), Int(1)))
    f === :qfrc_inverse && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 41040)), (Int(model.nv), Int(1)))
    f === :cacc && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 41048)), (Int(model.nbody), Int(6)))
    f === :cfrc_int && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 41056)), (Int(model.nbody), Int(6)))
    f === :cfrc_ext && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 41064)), (Int(model.nbody), Int(6)))
    f === :contact && return UnsafeArray(unsafe_load(Ptr{Ptr{mjContact_}}(internal_pointer + 41072)), (Int(data.ncon), Int(1)))
    f === :efc_type && return UnsafeArray(unsafe_load(Ptr{Ptr{Int32}}(internal_pointer + 41080)), (Int(data.nefc), Int(1)))
    f === :efc_id && return UnsafeArray(unsafe_load(Ptr{Ptr{Int32}}(internal_pointer + 41088)), (Int(data.nefc), Int(1)))
    f === :efc_J_rownnz && return UnsafeArray(unsafe_load(Ptr{Ptr{Int32}}(internal_pointer + 41096)), (Int(data.nefc), Int(1)))
    f === :efc_J_rowadr && return UnsafeArray(unsafe_load(Ptr{Ptr{Int32}}(internal_pointer + 41104)), (Int(data.nefc), Int(1)))
    f === :efc_J_rowsuper && return UnsafeArray(unsafe_load(Ptr{Ptr{Int32}}(internal_pointer + 41112)), (Int(data.nefc), Int(1)))
    f === :efc_J_colind && return UnsafeArray(unsafe_load(Ptr{Ptr{Int32}}(internal_pointer + 41120)), (Int(data.nnzJ), Int(1)))
    f === :efc_JT_rownnz && return UnsafeArray(unsafe_load(Ptr{Ptr{Int32}}(internal_pointer + 41128)), (Int(model.nv), Int(1)))
    f === :efc_JT_rowadr && return UnsafeArray(unsafe_load(Ptr{Ptr{Int32}}(internal_pointer + 41136)), (Int(model.nv), Int(1)))
    f === :efc_JT_rowsuper && return UnsafeArray(unsafe_load(Ptr{Ptr{Int32}}(internal_pointer + 41144)), (Int(model.nv), Int(1)))
    f === :efc_JT_colind && return UnsafeArray(unsafe_load(Ptr{Ptr{Int32}}(internal_pointer + 41152)), (Int(data.nnzJ), Int(1)))
    f === :efc_J && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 41160)), (Int(data.nnzJ), Int(1)))
    f === :efc_JT && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 41168)), (Int(data.nnzJ), Int(1)))
    f === :efc_pos && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 41176)), (Int(data.nefc), Int(1)))
    f === :efc_margin && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 41184)), (Int(data.nefc), Int(1)))
    f === :efc_frictionloss && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 41192)), (Int(data.nefc), Int(1)))
    f === :efc_diagApprox && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 41200)), (Int(data.nefc), Int(1)))
    f === :efc_KBIP && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 41208)), (Int(data.nefc), Int(4)))
    f === :efc_D && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 41216)), (Int(data.nefc), Int(1)))
    f === :efc_R && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 41224)), (Int(data.nefc), Int(1)))
    f === :efc_b && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 41232)), (Int(data.nefc), Int(1)))
    f === :efc_force && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 41240)), (Int(data.nefc), Int(1)))
    f === :efc_state && return UnsafeArray(unsafe_load(Ptr{Ptr{Int32}}(internal_pointer + 41248)), (Int(data.nefc), Int(1)))
    f === :efc_AR_rownnz && return UnsafeArray(unsafe_load(Ptr{Ptr{Int32}}(internal_pointer + 41256)), (Int(data.nefc), Int(1)))
    f === :efc_AR_rowadr && return UnsafeArray(unsafe_load(Ptr{Ptr{Int32}}(internal_pointer + 41264)), (Int(data.nefc), Int(1)))
    f === :efc_AR_colind && return UnsafeArray(unsafe_load(Ptr{Ptr{Int32}}(internal_pointer + 41272)), (Int(data.nefc), Int(data.nefc)))
    f === :efc_AR && return UnsafeArray(unsafe_load(Ptr{Ptr{Float64}}(internal_pointer + 41280)), (Int(data.nefc), Int(data.nefc)))
    error("Could not find property $(f)")
end
